...
public class AnimalMonitor 
{
    ...
    /**
     * Print the details of all the sightings during a given period.
     * @param period ID.
     */
    public void printSightingsDuring(int period)
    {
        sightings.stream()
                 ...
                 .forEach(sighting -> System.out.println(sighting));
    }
    ...
    /**
     * Print all the sightings of a given animal during a given time period.
     */
    public void printSightings(String animal, int period)
    {
        sightings.stream()
                 .filter(sighting -> period == sighting.getPeriod())
                 .filter(sighting -> animal.equals(sighting.getAnimal()))
